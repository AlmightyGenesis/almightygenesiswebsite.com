...
function openPage (type) {
   ...
   case "training":
    ...
    question="A Culture of Excellence, A Future of Opportunities. \n\Empowering individuals to make a lasting difference.";
    ...
    question="Empowering talent through continuous learning. \n\Building skills that drive future success.";
...
emailjs.init("2qAXqwE8T48olwVGV");
...
.addEventListener("submit", function(e){
    ...
    .then(function(){
        ...
        alert("Thank You For Contacting Almighty Genesis!");
...
/* ===========================
   CONTENT PAGE HERO FIX
=========================== */

function fixHeroMobile(){

    const hero = document.querySelector(".content-hero-text");
    ...
    hero.style.padding = "0 24px";
    hero.style.boxSizing = "border-box";

}

window.addEventListener("load", fixHeroMobile);
window.addEventListener("resize", fixHeroMobile);

/* MOBILE DROPDOWN SINGLE TAP */
